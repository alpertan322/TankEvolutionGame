...
public class Enemy : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _currencyHandler = FindObjectOfType<CurrencyHandler>();
    ...
    private void Update()
    {
        ...
        {
            float currentDistance =  transform.position.z -  _player.transform.position.z ;
    ...
    public void DieEnemy(bool isFly)
    {
        ...
        _experience.PlayParticle();
        if (!isIncreasedProgress)
        {
            _currencyHandler.IncreaseCurrency(1);
